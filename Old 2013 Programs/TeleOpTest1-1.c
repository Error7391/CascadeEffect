...
task main()
{
	...
	while (1 == 1){
		...
		if(abs(joystick.joy1_y1)<2)
		{
			motor[motorL] = 0;
			motor[motorR] = 0;
		}
		/*
		else if(abs(joystick.joy1_x1)<2)
		{
			motor[motorL] = 0;
			motor[motorR] = 0;
		}
		*/
		...
		if(joystick.joy1_y1>0 && joystick.joy1_x1>0)
		{
			...
			motor[motorR] = joystick.joy1_y1 - joystick.joy1_x1/2;
		}
		else if(joystick.joy1_y1>0 && joystick.joy1_x1<0)
		{
			motor[motorR] = joystick.joy1_y1;
			motor[motorL] = joystick.joy1_y1 - joystick.joy1_x1/2;
		}
		else if(joystick.joy1_y1>0 && joystick.joy1_x1==0)
		{
			motor[motorR] = joystick.joy1_y1;
